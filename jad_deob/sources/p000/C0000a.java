...
public final class C0000a {
    ...
    public C0000a(boolean z) {
        ...
        Image a = C0010k.m70a(str);
        if (a != null) {
            this.f3a = 11;
            this.f4a = a.getWidth();
            this.f9b = a.getHeight();
            this.f7a = new C0004e[this.f11c];
            for (int i3 = 0; i3 < this.f11c; i3++) {
                this.f7a[i3] = new C0004e(null);
            }
            this.f13d = 0;
            int[] iArr = new int[(this.f4a * this.f9b)];
            a.getRGB(iArr, 0, this.f4a, 0, 0, this.f4a, this.f9b);
            this.f14d = new byte[(this.f4a * this.f9b)];
    ...
    /* renamed from: a */
    private static char m0a(char c) {
        if (c >= ' ' && c <= 255) {
            return (char) (c - ' ');
        }
        switch (c) {
    ...
    private int m1a(String str, int i, int i2) {
        ...
        while (i < i4) {
            i3 += this.f6a[m0a(str.charAt(i))] + this.f8b;
            i++;
        }
        return i3;
    }
    ...
    private int m2a(Graphics graphics, char c, int i, int i2) {
        ...
        if (a != 0) {
            if (this.f5a.f78a != null) {
                graphics.drawRegion(m3a(this.f12c[a]), this.f10b[a], 0, this.f6a[a], this.f3a, 0, i, i2, 0);
            } else {
                graphics.drawRGB(m5a(this.f12c[a]), this.f10b[a], this.f4a, i, i2, this.f6a[a], this.f3a, false);
            }
        }
    ...
    private Image m3a(byte b) {
        if (this.f5a.f78a[b] == null) {
            int i = this.f4a * this.f3a;
            int i2 = b * i;
            for (int i3 = 0; i3 < i; i3++) {
                f0a[i3] = this.f5a.f76a[this.f14d[i3 + i2]];
            }
            this.f5a.f78a[b] = Image.createRGBImage(f0a, this.f4a, this.f3a, false);
        }
    ...
    private void m4a(int i, int i2) {
        if (!(this.f5a != null && this.f5a.f75a == i && this.f5a.f80b == i2)) {
            ...
            if (f0a == null || f0a.length < this.f4a * this.f3a) {
                f0a = new int[(this.f4a * this.f3a)];
            }
            this.f5a.f75a = i;
            this.f5a.f80b = i2;
    ...
    private int[] m5a(byte b) {
        if (!this.f5a.f79a[b]) {
            ...
            int i = this.f3a * this.f4a;
            int i2 = b * i;
            if (this.f5a.f77a[b] == null) {
                this.f5a.f77a[b] = new int[(this.f4a * this.f3a)];
            }
    ...
    /* renamed from: a */
    public final int mo1a(String str) {
    ...
    public final int mo2a(char[] cArr, int i, int i2) {
        ...
        int i4 = i + i2;
        while (i < i4) {
            i3 += this.f6a[m0a(cArr[i])] + this.f8b;
            i++;
        }
        return i3;
    }
    ...
    public final void mo5a(Graphics graphics, String str, int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        if (length != 0) {
            int a = (i3 & 1) != 0 ? i - (mo1a(str) / 2) : (i3 & 8) != 0 ? i - mo1a(str) : i;
            if ((i3 & 32) != 0) {
                i2 -= this.f3a;
            }
