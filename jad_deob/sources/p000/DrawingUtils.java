...
public final class DrawingUtils {
    ...
    public static int m56a(Font font, String str, boolean z) {
        return (!f148L || z) ? font.stringWidth(str) : m60a(font).strFontLengthThing(str);
    }
    ...
    public static void drawFocus(Graphics graphics, int i, int i2, int i3, int i4) {
        graphics.setColor(RunnableC0018s.skin_colors[13]);
        ...
        graphics.setColor(RunnableC0018s.skin_colors[14]);
        graphics.drawLine(i - 2, i2 + i4, i - 2, i2 - 1);
        graphics.drawLine(i - 1, i2 - 2, i + i3 + f185g, i2 - 2);
        graphics.setColor(RunnableC0018s.skin_colors[15]);
