...
public final class C0010k {
    ...
    /* renamed from: I */
    public static boolean f145I = true;
    ...
    /* renamed from: L */
    public static boolean f148L = false;

    /* renamed from: M */
    public static boolean f149M = true;

    /* renamed from: N */
    public static boolean f150N = false;
    ...
    /* renamed from: Q */
    public static boolean f153Q = false;
    ...
    /* renamed from: a */
    public static long f156a = 0;

    /* renamed from: a */
    public static C0000a f157a = null;
    ...
    /* renamed from: b */
    public static C0000a f165b = null;
    ...
    /* renamed from: c */
    private static String[] f175c = null;

    /* renamed from: d */
    public static int f176d = 8;
    ...
    /* renamed from: f */
    public static String f183f = "google";
    ...
    /* renamed from: g */
    public static String f186g = "http://80.232.117.10:80/";
    ...
    /* renamed from: t */
    public static boolean f205t = false;
    ...
    public static int m56a(Font font, String str, boolean z) {
        return (!f148L || z) ? font.stringWidth(str) : m60a(font).mo1a(str);
    }

    /* renamed from: a */
    public static int m57a(Font font, char[] cArr, int i, int i2, boolean z) {
        return (!f148L || z) ? font.charsWidth(cArr, i, i2) : m60a(font).mo2a(cArr, i, i2);
    }
    ...
    /* renamed from: a */
    public static C0000a m60a(Font font) {
        return font.isBold() ? f165b : f157a;
    }

    /* renamed from: a */
    public static final InputStream m61a(String str) {
    ...
    /* renamed from: a */
    public static final String m62a(int i) {
        if (f175c == null) {
            m126h();
        }
        return (f175c == null || i < 0 || i >= f175c.length || f175c[i] == null) ? "?" : f175c[i];
    }

    /* renamed from: a */
    public static final String m63a(int i, String str) {
        String a = m62a(i);
    ...
    /* renamed from: a */
    public static final String m64a(String str) {
        try {
    ...
    /* renamed from: a */
    public static String m65a(String str, boolean z, boolean z2) {
        if (str == null) {
            return str;
        }
    ...
    /* renamed from: a */
    public static String m66a(Font font, String str, int i, boolean z) {
    ...
    /* renamed from: a */
    public static final Image m70a(String str) {
        Image image = null;
        try {
    ...
    /* renamed from: a */
    public static Image m72a(byte[] bArr, int i, int i2) {
        if (f206u && i != 0) {
        ...
        if (jVar.mo27a(bArr, i, i2) == -1 || jVar.f98a <= 0 || jVar.f104b <= 0) {
            return null;
        }
        return Image.createRGBImage(jVar.f100a, jVar.f98a, jVar.f104b, false);
    }

    /* renamed from: a */
    public static short m73a(Font font, boolean z) {
        return (!f148L || z) ? (short) (font.getHeight() + f193j + f195k) : m60a(font).mo3a();
    }
    ...
    public static void m75a() {
        System.gc();
        if (f192i) {
            f156a = (Runtime.getRuntime().freeMemory() * 10) / 8;
        } else if (!f194j || f156a <= 0) {
    ...
    /* renamed from: a */
    public static void m81a(Graphics graphics, int i, int i2, int i3, int i4) {
        graphics.setColor(RunnableC0018s.f351c[13]);
        ...
        graphics.setColor(RunnableC0018s.f351c[14]);
        graphics.drawLine(i - 2, i2 + i4, i - 2, i2 - 1);
        graphics.drawLine(i - 1, i2 - 2, i + i3 + f185g, i2 - 2);
        graphics.setColor(RunnableC0018s.f351c[15]);
    ...
    /* renamed from: a */
    public static void m82a(Graphics graphics, int i, int i2, int i3, int i4, int i5, int i6) {
        int i7 = (i5 >> 16) << 8;
        int i8 = ((i5 >> 8) & 255) << 8;
        int i9 = (i5 & 255) << 8;
    ...
    /* renamed from: a */
    public static void m83a(Graphics graphics, int i, int i2, int i3, int i4, boolean z) {
    ...
    public static final void m86a(MIDlet mIDlet) {
        f158a = m64a("microedition.platform");
        ...
        String a = m64a("microedition.profiles");
    ...
    private static void m88a(RecordStore recordStore) throws IOException, RecordStoreException {
        if (recordStore != null) {
            C0016q qVar = new C0016q();
            DataOutputStream dataOutputStream = new DataOutputStream(qVar);
            dataOutputStream.writeByte(8);
            dataOutputStream.writeBoolean(f144H);
            dataOutputStream.writeBoolean(f145I);
            dataOutputStream.writeBoolean(f146J);
            dataOutputStream.writeBoolean(!f151O);
            dataOutputStream.writeBoolean(f148L);
            dataOutputStream.writeUTF(f180e == null ? "" : f180e);
            dataOutputStream.writeBoolean(f149M);
            dataOutputStream.writeInt(f188h);
            dataOutputStream.writeBoolean(f153Q);
            dataOutputStream.writeUTF(f166b == null ? "" : f166b);
            dataOutputStream.writeLong(f156a);
            dataOutputStream.writeUTF(f183f == null ? "" : f183f);
            if (f186g.equals("http://80.232.117.10:80/")) {
                dataOutputStream.writeUTF("");
            } else {
                dataOutputStream.writeUTF(f186g);
            }
            dataOutputStream.writeInt(f191i);
            dataOutputStream.writeUTF(f172c == null ? "" : f172c);
            dataOutputStream.writeBoolean(f139C);
            dataOutputStream.writeLong(f171c);
            dataOutputStream.writeBoolean(f150N);
            dataOutputStream.writeUTF(f177d == null ? "" : f177d);
            recordStore.addRecord(qVar.mo57a(), 0, qVar.size());
        }
    }
        ...
        if (recordStore != null) {
            ...
            if (enumerateRecords.hasNextElement()) {
                ...
                if (dataInputStream.readUnsignedByte() == 8) {
                    f144H = dataInputStream.readBoolean();
                    f145I = dataInputStream.readBoolean();
                    f146J = dataInputStream.readBoolean();
                    if (!dataInputStream.readBoolean()) {
                        z = true;
                    }
                    f151O = z;
                    f148L = dataInputStream.readBoolean();
                    f180e = dataInputStream.readUTF();
                    f149M = dataInputStream.readBoolean();
                    f188h = dataInputStream.readInt();
                    f153Q = dataInputStream.readBoolean();
                    f166b = dataInputStream.readUTF();
                    f156a = dataInputStream.readLong();
                    String readUTF = dataInputStream.readUTF();
                    if (readUTF != null) {
                        f183f = readUTF;
                    }
                    f186g = dataInputStream.readUTF();
                    if (f186g == null || f186g.length() == 0) {
                        f186g = "http://80.232.117.10:80/";
                    }
                    f191i = dataInputStream.readInt();
                    f172c = dataInputStream.readUTF();
                    f139C = dataInputStream.readBoolean();
                    f171c = dataInputStream.readLong();
                    f150N = dataInputStream.readBoolean();
    ...
    public static byte[] m113b() {
        ...
        try {
            bArr = new byte[395];
            InputStream a = m61a("/defaultfavicon.png");
            if (a != null) {
    ...
    public static void m124f() {
        if (f148L) {
            try {
                if (f157a == null) {
                    f157a = new C0000a(false);
                }
                if (f165b == null) {
                    f165b = new C0000a(true);
                }
    ...
    public static void m125g() {
        Font font = Font.getFont(64, 0, f176d);
    ...
    /* renamed from: h */
    private static void m126h() {
        byte b;
        if (f180e.length() == 0) {
            f180e = m64a("microedition.locale");
            if (f180e != null) {
                if (f180e.startsWith("no")) {
                    f180e = "nb-NO";
                } else if (f180e.startsWith("sv")) {
                    f180e = "sv-SE";
                } else if (f180e.startsWith("da")) {
                    f180e = "da-DK";
                } else if (f180e.startsWith("fi")) {
                    f180e = "fi-FI";
                } else if (f180e.startsWith("is")) {
                    f180e = "nb-NO";
                } else if (f180e.startsWith("de")) {
                    f180e = "de-DE";
                } else if (f180e.startsWith("nl")) {
                    f180e = "nl-NL";
                } else if (f180e.startsWith("bg")) {
                    f180e = "bg-BG";
                }
            }
        }
        if (f180e == null || f180e.length() == 0) {
            f180e = "en-US";
        }
        InputStream a = m61a("/l");
        if (a != null) {
            try {
                DataInputStream dataInputStream = new DataInputStream(a);
                if (3 == dataInputStream.readShort()) {
                    int readByte = dataInputStream.readByte();
                    f161a = new String[readByte];
                    f169b = new String[readByte];
                    byte b2 = -1;
                    for (byte b3 = 0; b3 < readByte; b3 = (byte) (b3 + 1)) {
                        String readUTF = dataInputStream.readUTF();
                        if (f180e != null && readUTF.startsWith(f180e)) {
                            f180e = readUTF;
                            b2 = b3;
                        }
                        f161a[b3] = readUTF;
                    ...
                    f175c = new String[readShort];
                    for (byte b4 = 0; b4 < readByte; b4++) {
                        f169b[b4] = dataInputStream.readUTF();
