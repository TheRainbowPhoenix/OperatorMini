...
public final class Code implements J, Runnable {
    ...
    private void H() {
        ...
        if (B == 14 && (var2.startsWith("zte-p80") || var2.startsWith("zte-f160"))) {
            O = false;
        }
        ...
        if (var4 != 0 && var5 != 0 && var6 != 0) {
            ...
            if (var1[var2] != 82 && var1[var2] != 67 && var1[var2] != 88) {
                ...
                if (!af && var1[var2] != -119) {
                    ...
                    if (var6 == 256) {
                        if (var23.Code(var1, var2, var3, 0, false) == 0 && var23.bm != 0 && var23.bk != 0) {
                            if (var23.bm >= var4 && var23.bk >= var5) {
                                var9 = this.Code(var23.x, var23.bm, var23.bk, false, var8);
                            } else {
                                var9 = this.Code((int[])var23.x, (int)var23.bm, var23.bk, var4, (int)var5, (int)1);
                            }
                        }
                    } else {
                        if (m()) {
                        ...
                        if (var23.Code(var1, var2, var3, var11, false) == 0) {
                            ...
                            var9 = this.Code((int[])var23.x, (int)var23.bm, var23.bk, var4, (int)var5, (int)var16);
                        }
                    }
                } else {
                    byte var28 = 0;
    ...
    private synchronized boolean v() {
        B[] var1 = this.aE ? this.N.Code : this.N.I;
        int var2 = this.aE ? 256 : this.H();
        int var3 = 0;
        int var4 = 0;
        ...
        while(true) {
            ...
            if (var1[var4] == null && (this.N.h[var3 + 2] & -2147483648) == 0 && this.c(var3) && this.b(this.N.h[var3 + 1])) {
                var5 = this.aR && this.N.h[var3 + 5] == 0;
                if (this.N.C <= 0) {
                    break;
                }
    ...
    private void Code(a var1, DataInputStream var2, int var3, int var4) {
        this.cj = (var4 << 16 | var2.readUnsignedShort()) + var1.g() - var3;
        ...
        while(var9 < var6) {
            ...
            switch(var10 & 127) {
                ...
                case 75:
                    ...
                    break;
                case 76:
                    this.I = var2.readByte();
                    this.cm = var2.readShort();
                    break;
                case 78:
                    var54 = var2.readUTF();
                    var61 = var2.readUTF();
        ...
        if (this.C != null && var8 > 0 && this.C.f == null) {
            this.f = null;
            throw new OutOfMemoryError();
        } else {
            if (this.f == null) {
                this.f = new byte[var44];
            }
            ...
            for(var6 = 0; var6 < var8; ++var6) {
                ...
                var11 = var78;
                var56 = this.f;
                System.arraycopy(this.C.f, var10, var56, var11, var9);
            }
            ...
            while(this.cr < var44) {
                ...
                while(true) {
                    while(this.cr - var10 < 1024 && this.cr < var44) {
                        var11 = Math.min(1024, Math.min(var6 < var8 ? var7[var6 * 3 + 1] - this.cr : 1024, var44 - this.cr));
                        if (var6 < var8 && this.cr == var7[var6 * 3 + 1]) {
                            this.cr += var7[var6 * 3 + 2];
                            ++var6;
                        } else {
                            if ((var11 = var1.read(this.f, this.cr, var11)) < 0) {
    ...
    private void au() {
        ...
        try {
            ...
            if ((var2 = this.N()) > 0) {
                ...
                byte[] var3 = this.h;
                System.arraycopy(this.f, this.cD, var3, 0, var2);
                this.cD += var2;
            }
            ...
            this.o = this.k();
            var2 = this.O();
            this.ba = (boolean)(var2 & 1);
            this.ck = (var2 & 6) >>> 1;
            this.aF = (boolean)((var2 & 16 | -(var2 & 16)) >>> 31);
            if (!this.aK) {
                this.aU = (boolean)((var2 & 8 | -(var2 & 8)) >>> 31);
    ...
    private static char Code(char var0) {
        if (var0 >= ' ' && var0 <= 255) {
            return (char)(var0 - 32);
        } else if (var0 >= 1040 && var0 <= 1103 && aJ) {
    ...
    private B Code(int var1, int var2, int var3, int var4, int var5, int var6, B[] var7) {
        boolean var8 = false;
        var7 = this.aR && var3 <= 0 && var4 <= 0 ? var7 : null;
        if (var3 > 0 && var4 > 0) {
            if (var2 < 256 && var2 > 0) {
        ...
        return var8 ? Z.Code(this.f, var1 + 2, B(this.f, var1), var2, var7, false) : Z.Code(this.f, var1 + 2, B(this.f, var1), var3, var4, -1, var7, false);
    }
    ...
    private void Code(byte[] var1, int var2) {
        this.h[this.b++] = (var1[var2] & 255) << 24 | (var1[var2 + 1] & 255) << 16 | (var1[var2 + 2] & 255) << 8 | var1[var2 + 3] & 255;
        if (this.b == 16) {
            this.L();
        }
    ...
    private void A() {
        ...
        while(true) {
            ...
            if (var2 > 1) {
                var1 = new Code(this, this.C, false, this.C);
            }
            ...
            if (var2 > 1) {
                ...
                label128: {
                    ...
                    try {
                        var9 = true;
                        var6 = l(var10000);
                        if (var12.b != null && var6 != 0) {
                            var11.Code((String)var12.b, (int[])null, var6);
                        }

                        var7 = new Code(var11, (byte)0);
                        if (var12.m.b && var11.Code(var7, var6, var12.m)) {
                            var7.b = true;
                        }
        ...
        try {
            ...
            for(int var9 = 0; var9 < 110; ++var9) {
                if (var4[var9] == null) {
                    ...
                    if ((this.I[var9] == null || !var4[var9].equals(this.I[var9])) && var4[var9] instanceof String) {
    ...
    private static void C(Code var0) {
        if (H) {
            ...
            int var2 = (v() - C.I(var1)) / 4 * 3;
            var0.J(var2 - 8, 1, C.I(var1) + 25, C.a() + 1, 11782531);
            var0.Code(var1, var2, 1, C, 16647045);
        }
    }
        ...
        while(var16 == 0) {
            ...
            switch(this.bh) {
                ...
                case 2:
                    ...
                    while(true) {
                        while(true) {
                            if (this.bn < 2 || var16 != 0 || this.br != 0 || this.bh != 1 && this.bh != 2) {
                                continue label497;
                            }

                            if ((this.f[this.bp] & 255) != 255) {
                                ++this.bp;
                                --this.bn;
                            } else {
                                switch(this.f[this.bp + 1] & 255) {
                                    case 0:
                                    case 255:
                                        ++this.bp;
                                        --this.bn;
                                    ...
                                    case 193:
                                        ...
                                        this.C = (this.f[this.bp + 2] & 255) << 8 | this.f[this.bp + 3] & 255;
                                        if (this.bn < 10) {
                                            return this.bn;
                                        }
                                        ...
                                        this.bn -= 4;
                                        this.C -= 2;
                                        this.cr = (this.f[this.bp + 3] & 255) << 8 | this.f[this.bp + 4] & 255;
                                        this.cs = (this.f[this.bp + 1] & 255) << 8 | this.f[this.bp + 2] & 255;
                                        if (var5) {
                                            this.bh = 0;
                                    ...
                                    case 196:
                                        ...
                                        if (this.bn < 4) {
                                            ...
                                            var2 = (this.f[this.bp + 2] & 255) << 8 | this.f[this.bp + 3] & 255;
                                            if (this.bn < var2 + 2) {
                                                var16 = -2;
                                                continue;
                                            }
                                            ...
                                            label483:
                                            while(var2 > 0) {
                                                var3 = var17.f[var17.bp] & 15 | (var17.f[var17.bp] & 16) >> 2;
                                                ++var17.bp;
                                                --var17.bn;
                                                --var2;
                                                var4 = 0;
                                                ...
                                                for(var8 = 0; var8 < 16; ++var8) {
                                                    var23[var8] = (short)(var17.f[var17.bp + var8] & 255);
                                                    var21 += var23[var8];
                                                }
                                                    ...
                                                    do {
                                                        if (var25[var9] == 0) {
                                                            ...
                                                            for(var8 = 0; var8 < var4; ++var8) {
                                                                var17.J[var3][var8] = var17.f[var17.bp + var8];
                                                            }
                                    ...
                                    case 218:
                                        ...
                                        this.cj = this.f[this.bp + 4] & 255;
                                        this.bp += 5;
                                        this.bn -= 5;
                                        this.C -= 3;

                                        for(var2 = 0; var2 < this.cj; ++var2) {
                                            var3 = this.f[this.bp] & 255;
                                            this.v[var2] = var2;

                                            for(var4 = 0; var4 < this.bl; ++var4) {
                                                if (var3 == this.g[var4]) {
                                                    this.v[var2] = var4;
                                                    var4 = this.bl;
                                                }
                                    ...
                                    case 219:
                                        ...
                                        if (this.bn < 4) {
                                            ...
                                            if (this.bn < var2 + 2) {
                                                ...
                                                while(true) {
                                                    while(var2 > 0) {
                                                        var10000 = var17.f[var17.bp] & 240;
                                                        var3 = (var10000 | -var10000) >>> 31;
                                                        var4 = var17.f[var17.bp] & 15;
                                                        ++var17.bp;
                                                        --var17.bn;
                                                        --var2;
                                                        ...
                                                        if (var3 != 0) {
                                                            for(var3 = 0; var3 < 64; ++var3) {
                                                                var6 = r[var3];
                                                                var17.J[var4][var3] = ((var17.f[var17.bp + (var6 << 1)] & 255) << 8 | var17.f[var17.bp + (var6 << 1) + 1] & 255) * s[var3];
                                                            }
                                                            ...
                                                            for(var3 = 0; var3 < 64; ++var3) {
                                                                var6 = r[var3];
                                                                var17.J[var4][var3] = (var17.f[var17.bp + var6] & 255) * s[var3];
                                                            }
                                    ...
                                    case 221:
                                        ...
                                        this.br = (this.f[this.bp + 2] & 255) << 8 | this.f[this.bp + 3] & 255;
                                        if (this.bn < 6) {
                                            return this.bn;
                                        }

                                        this.cn = (this.f[this.bp + 4] & 255) << 8 | this.f[this.bp + 5] & 255;
                                        this.cm = 0;
                                        this.bp += 6;
                                        this.bn -= 6;
                                        this.br -= 4;
                ...
                case 3:
                    ...
                    for(var2 = 0; var2 < this.bl; ++var2) {
                        this.g[var2] = this.f[this.bp] & 255;
                        var4 = (var3 = this.f[this.bp + 1] & 255) & 15;
                        if ((var3 >>>= 4) > this.bq) {
                            this.bq = var3;
                        }
                        ...
                        this.t[var2] = var3;
                        this.I[var2] = var4;
                        this.z[var2] = this.f[this.bp + 2] & 255;
                        this.bp += 3;
                        this.bn -= 3;
                        this.C -= 3;
                    }
                ...
                case 4:
                    ...
                    do {
                        ...
                        --var17.co;
                        if (var17.co % var17.cp == 0 && var17.bo != 0) {
                            var17.b(true);
                            Code var20 = var17;
                            var6 = var17.cv % var17.cr;
                            var21 = var17.cv / var17.cr;
                            var6 >>= var17.bo;
                            var6 += (var21 >>= var17.bo) * var17.bm;
                            var8 = 0;

                            for(var9 = 0; var9 < var20.a << 3 >> var20.bo && var9 + var21 < var20.bk; ++var9) {
                                for(var10 = 0; var10 < var20.cw >> var20.bo; ++var10) {
                                    var20.x[var6 + var10] = var20.h[var8 + (var10 << var20.bo)];
                                }

                                var6 += var20.bm;
                                var8 += var20.bq << 3 << var20.bo;
                            }
                        ...
                        if (var17.co == 0) {
                            ...
                            ++var17.cq;
                            if (var17.cj > 1 && var17.cq >= var17.b / (8 * var17.a) || var17.cj == 1 && var17.cq >= ((var17.I[var3] * var17.cs + var17.a - 1) / var17.a + 7) / 8) {
                                var17.bh = 2;
                                var16 = 0;
                                continue label497;
                            }
                    ...
                    while(true) {
                        while(true) {
                            while(true) {
                                ...
                                if ((this.f[this.bp] & 255) == 255 && this.f[this.bp + 1] != 0) {
                                    if ((this.f[this.bp + 1] & 255) >= 208 && (this.f[this.bp + 1] & 255) <= 215) {
                                        this.bh = 4;
                                        this.bp += 2;
                                        this.bn -= 2;
                                    } else {
    ...
    private void b(boolean var1) {
        int var2;
        int var3 = (var2 = this.a << 3) * this.cq;
        int[] var4 = new int[3];
        int[] var5 = new int[3];
        int[] var6 = new int[3];
        int[] var7 = new int[3];
        if (this.bl == 3) {
            var4[0] = 0;
            var5[0] = (this.I[0] << 11) / this.a;
            var7[0] = (this.t[0] << 11) / this.bq;
            var4[1] = 0;
            var5[1] = (this.I[1] << 11) / this.a;
            var7[1] = (this.t[1] << 11) / this.bq;
            var4[2] = 0;
            var5[2] = (this.I[2] << 11) / this.a;
        ...
        for(int var9 = 0; var9 < var2; ++var9) {
            if (var3 + var9 < this.cs && this.bl == 3) {
    ...
    private void as() {
        while(this.cu <= 24 && this.bn > 0) {
            int var1;
            if ((var1 = this.f[this.bp] & 255) == 255) {
    ...
    private int Code(DataInput var1, int var2) {
        if (this.c) {
            ...
            if (!this.b) {
                ...
                this.Code = (byte)(var4 & 7);
                this.B = (boolean)((var4 & 8 | -(var4 & 8)) >>> 31 ^ 1);
                this.I = (byte)((var4 & 112) >> 4);
                this.b = var1.readInt();
    ...
    public static int Code(String var0, String var1) {
        ...
        try {
            ...
            for(int var2 = 0; var2 < Code.length; ++var2) {
                ...
                Code var7 = var12;
                if (I(var12.c, var6) && I(var7.d, var5) && (var7.cp == 0 || var4 == var7.cp) && I(var7.b, var3)) {
                    if (Code[var2].bm == 255) {
    ...
    private void v() {
        ...
        while(var2 < var1.length) {
            if (var1[var2] == null) {
                ...
                Code((Vector)this.Code, (Object)(new Object[]{var1[var2].d, new Integer(7), var1[var2].b, null}));
                ++var2;
            }
        }
    ...
    private int s(int var1) {
        return ((Code)this.Code.elementAt(var1)).bk;
    }

    private int p(int var1) {
        return ((Code)this.Code.elementAt(var1)).bl;
    }
    ...
    private Code(byte[] var1, int var2, int var3) {
        ...
        System.arraycopy(var1, var2, this.f, 0, var3);
    ...
    private void I(byte[] var1) {
        ...
        Code(this.bo, var1, 8);
        Code(this.a, var1, 12);
        Code(this.bp, var1, 16);
        Code(this.bn, var1, 20);
        Code(this.bh, var1, 24);
        Code(this.bm, var1, 28);
        this.K();
    }
    ...
    public final void I(String var1, String var2) {
        ...
        if (this.cF >= var3) {
            ...
            for(int var4 = 0; var4 < this.cF; ++var4) {
        ...
        this.B[this.cF++] = new Code(var1, var2);
    }
    ...
    private void C(byte[] var1, int var2, int var3) {
        ...
        this.k.I(this.Code);
        System.arraycopy(this.Code, 0, var1, var2, var3);
        this.k.a(this.h, 0, 64);
    }
    ...
    private synchronized boolean l() {
        Code var1;
        if ((var1 = this.n).aE && !var1.B.Code() && !var1.a.Code()) {
            B var10000 = var1.B;
            B var3 = var1.a;
            B var2 = var10000;
        ...
        if (!this.b.equals("file:///") && !this.b.equals("file://localhost/")) {
            ...
            if (this.Code != null) {
                ...
                while(this.Code.hasMoreElements()) {
                    ...
                    int var3;
                    Code((Vector)(((var3 = 3 | var2.endsWith("/") << 2) & 4) == 0 ? this.Code : var1), (Object)(new Object[]{this.b + var2, new Integer(var3), var2, null}));
                }
    ...
    private boolean J(String var1) {
        if (this.d != null && var1 != null) {
            return this.d.equals(a(var1));
        } else {
            return this.d == null && var1 == null;
        }
    }
    ...
    private void B(Code var1) {
        this.C = new Code(this, var1, true, this.C);
            ...
            switch(var1) {
                ...
                case 4:
                    label251: {
                        ...
                        while(true) {
                            if (var6 >= var5.length()) {
                                var12 = (var4 = var3.Code).cs + var4.G();
    ...
    private boolean n() {
        return B.elementAt(this.C) != this;
    }
    ...
    private synchronized boolean o() {
        return this.br > 0 && (this.Z >= this.C ? Math.max(this.Z, this.B) + 240000L : (this.I() ? this.C : Math.max(this.C, this.B)) + (long)this.br) - System.currentTimeMillis() < 0L;
    }
    ...
    private synchronized void k(int var1, int var2) {
        J(var2, 0);
        System.arraycopy(this.w, var1 * 5, Code, Code, 5);
    }
    ...
    private Code(int var1, byte var2, boolean var3) {
        ...
        if ((var5 = y()) == 460) {
            ...
            label106: {
                if (var5 == -1) {
                    String var8;
                    int var6 = (var8 = Code((int)0).o).indexOf(46);
        ...
        if (!this.q.A()) {
            var10 = this.Code;
            var10001 = 0;
            var10002 = "socket://" + this.q.o + ":" + this.q.cq;
        } else {
            var10 = this.Code;
            var10001 = 0;
        ...
        if ((var9 = (Object[])C.get(var4)) != null) {
            ...
            this.r = new Code(Code((byte[])Z(this.q.q), 0, 160));
            this.Z = new Object[2];
            this.Z[0] = this.r;
            this.Z[1] = "";
            C.put(var4, this.Z);
        ...
        this.I = var2 != -1 ? var2 : (J >= 0 && !this.q.A() ? J : (B >= 0 ? B : 1));
        if (B.size() <= var1) {
            B.setSize(var1 + 1);
        }
    ...
    private a Code() {
        ...
        try {
            var5 = true;
            if (!var10000.I() && this == B.elementAt(this.C)) {
                B.setElementAt((Object)null, this.C);
            }

            while(Z == null || Z != null && (this.C != Z.Code() || this.I() && this.n() && this != Z.Code())) {
                if (this.y) {
                    for(int var2 = 0; var2 < this.Code.size(); ++var2) {
                        a var3;
    ...
    private void Code(a var1, byte[] var2) {
        String var3;
        int var4;
        if ((var4 = (var3 = this.Code[this.I]).indexOf(59)) >= 0) {
            ...
            if (!this.q.z() || this.g[8] != 32 || this.g[9] != 51 || this.g[10] != 48 || this.g[11] != 49 && this.g[11] != 50 && this.g[11] != 51 && this.g[11] != 55) {
                ...
                if (var2 != null && var2.length() != 0) {
                    ...
                    for(a var4 = Z; var4 != null; var4 = var21) {
                        ...
                        try {
                            var8 = true;
                            if (var21.Code() == this.C && !var4.Z() && var4 != var1) {
                                if (var4.J(var2)) {
                                    M();
                                } else {
                                    var4.close();
    ...
    private int v(int var1) {
        return (var1 = var1 + 2 + this.C.E(var1)) < this.C.f.length && this.C.F(var1) == 84 ? var1 : -1;
    }
    ...
    private static Code I(int var0) {
        return new Code(var0, y.cI, Code((String)y.o, (int)1), y.b, y.cq, y.q, y.o);
    }
    ...
    private static int Code(int var0, int var1, int var2, int var3, int var4, int var5) {
        ...
        for(var3 = 0; var3 < var11.Code.size(); ++var3) {
                                                                                            ...
                                                                                            if (var10000) {
                                                                                                ...
                                                                                                if (var10000) {
                                                                                                    ...
                                                                                                    if (var10000) {
                                                                                                        ...
                                                                                                        if (var10000) {
                                                                                                            var10000 = ((Code)var12).aL;
                                                                                                            if (var10000) {
                                                                                                                var10000 = ((Code)var12).aE;
                                                                                                            }
                                                                                                        }
                                                                                                    }
                                                                                                }
            ...
            a(P, var4);
            var17 = P;
            var4 = ((Code)var11.Code.elementAt(var3)).br;
            a(var17 + 2, var4);
            var4 = O;
            a(P + 1, var4);
            var17 = P;
    ...
    public final int I(String var1) {
        if (this.aY) {
            ...
            for(int var5 = 0; var5 < var6; ++var5) {
                var4 += var3.f[Code(var2.charAt(var5))];
            }
    ...
    public final int b() {
        return this.aY ? this.a() + this.I + this.Code : a;
    }

    public final int c() {
        return this.aY ? this.Code.getBaselinePosition() : a;
    }
    ...
    private Code(boolean var1, Code var2) {
        ...
        if (r == null) {
            ...
            label979: {
                ...
                label972: {
                    int var58;
                    try {
                        if (aJ = (var51 = Code((int)var10000)).readByte() > 0) {
                            cf = 299;
                            cg = 14;
                        } else {
                            cf = 225;
        ...
        if (var55 != null) {
            this.bm = var55.Code.getWidth();
            this.a = var55.Code.getHeight();
            ...
            this.bp = 0;
            int[] var52 = new int[this.bm * this.a];
            var55.Code(var52, this.bm, 0, 0, this.bm, this.a);
            ...
            for(var53 = 0; var53 < var56; ++var53) {
                this.g[var53] = (byte)(7 - ((var52[var53] & 255) >> 5));
                this.h[this.g[var53]] = 255 - (var52[var53] & 255);
            }
            ...
            this.h = new byte[cf];
            this.Code = new byte[cf];
            byte var54 = 0;
            byte var57 = 0;

            for(var53 = 0; var53 < cf; ++var53) {
                if (var54 + this.f[var53] >= this.bm) {
                    var54 = 0;
                    ++var57;
                }

                this.h[var53] = var54;
                this.Code[var53] = var57;
                var54 += this.f[var53];
            }
    ...
    public final String Code() {
        if (!this.Z()) {
            ...
            int var1;
            if ((var1 = this.b.indexOf(59)) < 0) {
                var1 = this.b.indexOf(10);
            }

            if (var1 >= 0) {
                String var2 = this.b.substring(0, var1);
                this.b = this.b.substring(var1 + 1);
                return var2;
            } else {
                String var3 = this.b;
                this.b = null;
        ...
        if ((var2 = Code(var2)) != 0) {
            ...
            if (this.G.I[var9] == null) {
                ...
                for(int var8 = 0; var8 < var6; ++var8) {
                    o[var8] = var5.G.x[var5.g[var8 + var7]];
                }

                var5.G.I[var9] = var5.F.Code(o, var5.bm, a, true, false);
            }

            var1.Code((B)var5.G.I[var9], this.h[var2], 0, this.f[var2], a, var3, var4);
        }
    ...
    private void C(int var1, int var2, int var3, int var4) {
        if (this.I(var1, var2, var3, var4)) {
            if (this.b > 0) {
                int var5 = this.bn + this.b;
                this.bn = Math.min(this.bn, var1);
                this.b = Math.max(var1 + var3, var5) - this.bn;
                var1 = this.co + this.cp;
                this.co = Math.min(this.co, var2);
                this.cp = Math.max(var2 + var4, var1) - this.co;
                return;
            }
        ...
        if (var4 < var6[var7 + -2]) {
            if ((var4 = this.J(var6, var7, var8, var4)) != var8) {
                ...
                for(var9 = var4; var9 != var8; ++var9) {
                    this.w[var9 * 5 + 3] = this.w[var9 * 5 + 2];
    ...
    private synchronized boolean C(int var1, int var2) {
        if (!this.y()) {
            ...
            int[] var3 = Code;
            int var4 = Code + 2;
            int var5 = this.I(var3, var4, var2, this.co);
            var2 = this.I(var3, var4, var2, this.co + this.cp);
            if (var5 == var2) {
                this.b = 0;
                return false;
            } else {
                if (var5 < 0) {
                    var5 = Math.max(var2 - this.cp, 0);
                } else if (var2 < 0) {
                    var2 = Math.min(var5 + this.cp, var3[var4 + -2]);
                }
    ...
    private synchronized void S(int var1) {
        ...
        for(int var5 = 0; var5 < var1; ++var5) {
            ...
            if ((var3[var4 + var5] & -2147483648) != 0) {
                var2 += this.w[var5 * 5 + 1];
                if ((var3[var4 + var5] & 1073741824) == 0) {
                    var3[var4 + -1] += this.w[var5 * 5 + 1];
                }
            }
        }
    ...
    private int Code(DataInputStream var1) {
        ...
        for(int var3 = 4; var1 != null && !this.aM && var3 > 0; var3 -= var1.read(var2, 4 - var3, var3)) {
        }
    ...
    private int a(int var1, int var2, int var3) {
        this.w[var1] = var2;
        this.w[var1 + 1] = var3;
        this.w[var1 + 2] = this.cB;
        this.w[var1 + 3] = this.cC;
        return var1;
    }
    ...
    private void P(int var1) {
        if (this.G == null || this.G.I == null || this.G.cu != var1) {
            int var2;
            for(var2 = 0; var2 < this.br; ++var2) {
                if (var1 == this.Z[var2].cu && this.Z[var2].I != null) {
                    this.G = this.Z[var2];
                    return;
                }
            }
    ...
    private synchronized void d(Code var1) {
        ...
        for(int var2 = 1; var2 < this.bp; ++var2) {
            this.J[var2] = null;
        }
    ...
    private synchronized void b(Code var1) {
        for(int var2 = 0; var2 < this.bp; ++var2) {
            if (this.J[var2] == var1) {
                this.J[var2] = this.J[--this.bp];
                this.J[this.bp] = null;
                if (var2 == 0) {
                    this.w = false;
                    return;
    ...
    private synchronized void c(Code var1) {
        if (!this.w) {
            int var2;
            for(var2 = 0; var2 < this.bp && this.J[var2] != var1; ++var2) {
            }

            if (var2 == this.bp) {
                if (this.bp == this.J.length) {
                    this.J[this.bp - 1] = var1;
                } else {
                    this.J[this.bp++] = var1;
                }
            }
    ...
    private void d(byte[] var1, int var2, int var3) {
        for(int var4 = 0; var4 < var3; ++var4) {
            this.cp = this.cp + 1 & 255;
            this.cj = this.f[this.cp] + this.cj & 255;
            byte var5 = this.f[this.cp];
            this.f[this.cp] = this.f[this.cj];
            this.f[this.cj] = var5;
            var1[var2 + var4] ^= this.f[this.f[this.cp] + this.f[this.cj] & 255];
        }
    ...
    private Code(byte[] var1) {
        ...
        for(int var4 = 0; var4 < 256; ++var4) {
            var3 = var1[var2] + this.f[var4] + var3 & 255;
            byte var5 = this.f[var4];
            this.f[var4] = this.f[var3];
            this.f[var3] = var5;
            var2 = (var2 + 1) % 32;
        }
    ...
    private void Code(Code var1, int var2, int var3, int var4) {
        ...
        switch(var5) {
            ...
            case 99:
                if (((var10 != null ? 1 : 0) ^ (var6 & 2 | -(var6 & 2)) >>> 31) != 0) {
                    var1.Code(this.Code(this.aL ? 256 : this.H(), var3, var4), this.cx, this.cy);
                }
                break;
            case 102:
        ...
        if (var22 != null) {
            ...
            this.Code(var1, var22, var13, var2, this.K.b, var4, true);
    ...
    public final int Code(char var1) {
        return this.aY ? this.Code.charWidth(var1) : this.f[Code(var1)];
    }

    public final DataOutputStream Code() {
        return this.aX ? this.Code.openDataOutputStream() : this.Code.openDataOutputStream();
    }
    ...
    public final boolean Code(int var1, int var2) {
        return Code(var1, var2, 1, 1, this.bm, this.cs, this.F(), this.G());
    }
    ...
    public final boolean I(Code var1) {
        return Code(this.bm, this.cs, this.F(), this.G(), var1.bm, var1.cs, var1.F(), var1.G());
    }
    ...
    private boolean Z(Code var1) {
        return Code(this.cs, this.G(), var1.cs, var1.G());
    }
    ...
    public final boolean Code(Code var1) {
        return I(this.bm, this.cs, this.F(), this.G(), var1.bm, var1.cs, var1.F(), var1.G());
    }

    private boolean a(Code var1) {
        return this.bm > var1.bm;
    }
    ...
    public final DataInputStream Code() {
        return this.aX ? this.Code.openDataInputStream() : this.Code.openDataInputStream();
    }
    ...
    private boolean b(int var1) {
        return var1 + 2 <= this.cr && var1 + B(this.f, var1) <= this.cr;
    }

    private boolean I(int var1, int var2, int var3, int var4) {
        for(int var5 = 1; var5 < this.y[0]; var5 += 4) {
            if (Code(var1, var2, var3, var4, this.y[var5], this.y[var5 + 1], this.y[var5 + 2], this.y[var5 + 3])) {
                return true;
            }
        }
    ...
    private int K() {
        this.cD += 4;
        int var1 = this.cD - 4;
        return (this.f[var1] << 24) + ((this.f[var1 + 1] & 255) << 16) + ((this.f[var1 + 2] & 255) << 8) + (this.f[var1 + 3] & 255);
    }
    ...
    private int K(int var1) {
        return Code(this.f, var1 + 2, B(this.f, var1));
    }
    ...
    private String a(int var1) {
        return Code(this.f, var1);
    }

    private int E(int var1) {
        return ((this.f[var1] & 255) << 8) + (this.f[var1 + 1] & 255);
    }

    private int F(int var1) {
        return this.f[var1] & 255;
    }
    ...
    private int I(int[] var1, int var2, int var3, int var4) {
        if (var3 == 0) {
            ...
            return (var1[var2 + var3] & -2147483648) == 0 ? -1 : var4 - this.w[var3 * 5] + (var1[var2 + var3] & 16777215);
        }
    }

    private int L(int var1) {
        int var2;
        return (var2 = B(this.f, var1)) > 0 && this.f[var1 + 2] == 0 ? Code(this.f, this.cw + 2, B(this.f, this.cw), this.f, var1 + 3, var2 - 1) : Code(this.f, var1 + 2, var2);
    }
    ...
    private int P() {
        ...
        int var1 = a(this.f, this.cE);
        return Z(this.f, this.cE + 3, var1);
    }

    private int P(int var1) {
        return var1 * v() / this.cv;
    }
    ...
    private void f(boolean var1) {
        ...
        if (this.K.u() == 0) {
            ...
            for(int var7 = 0; var7 < this.br; ++var7) {
                int var3 = this.w[var7 * 5 + 4];
    ...
    private synchronized int N(int var1) {
        label92:
        for(this.cD = var1; this.cD < this.f.length && this.cr == this.f.length || this.cD < this.cr - 16; var1 = this.cD) {
            int var2 = this.cD;
            int var3;
            int var4;
            switch(var3 = this.O()) {
                ...
                case 77:
                    ...
                    switch(var2) {
                        case 67:
                            ...
                            for(var3 = 0; var3 / 5 < this.br; var3 += 5) {
                                var4 = this.L();
                                this.w[var3] = var2;
                                this.w[var3 + 1] = var4;
                                this.w[var3 + 2] = var1;
                                this.w[var3 + 4] = this.O();
                                var1 += 4 * this.N() + 1;
                                var2 += var4;
                            }
                        ...
                        case 73:
                            ...
                            while(true) {
                                ...
                                this.t[var1] = this.O();
                                this.t[var1 + 1] = this.L();
                                this.t[var1 + 2] = this.L();
                                this.t[var1 + 3] = this.N();
                                this.t[var1 + 4] = this.N();
                                var1 += 5;
                            }
                        case 80:
                            var1 = this.O();
                ...
                default:
                    ...
                    var2 = var2;
                    Code var6 = this;
                    var4 = this.g(this.cy, this.br);

                    do {
                        int var5;
                        for(var5 = var6.w[var4 * 5 + 2]; var6.w[var5 + 4] != 0; var5 += 4) {
                        }

                        if (var6.w[var5] == 0) {
                            var6.a(var5, var2, var1);
                        } else if (var6.w[var5 + 1] + var6.az >= var2) {
                            var6.w[var5 + 1] = var1;
                        } else {
                        ...
                        ++var4;
                    } while(var4 < var6.br && var6.cy + var6.cA > var6.w[var4 * 5]);
    ...
    private int Q(int var1) {
        return var1 * this.cv / this.cn;
    }

    private int f(int var1, int var2) {
        return var1 * this.cv / var2;
    }

    private int b(int var1, int var2, int var3) {
        return var1 <= var3 ? var1 : (var1 - var3) * this.cv / var2 + var3;
    }

    private int Z(int[] var1, int var2, int var3, int var4) {
        int var5;
        return (var5 = this.J(var1, var2, var3, var4)) >= var3 ? this.bo : var4 + this.w[var5 * 5] - (var1[var2 + var5] & 16777215);
    }
    ...
    private synchronized int g(int var1, int var2) {
        int var3;
        for(var3 = Code((int[])this.w, (int)var2, 5, var1); var3 > 0 && (var3 == var2 || this.w[var3 * 5] == this.w[(var3 - 1) * 5] || this.w[var3 * 5] > var1); --var3) {
        }
    ...
    private int R(int var1) {
        if (var1 == 0) {
            int var10000 = this.y[0];
            Z(var10000, var10000);
        } else {
            Code(var1, this.y[0], false);
        }

        System.arraycopy(this.y, 1, Code, Code, this.y[0]);
        return m();
    }
    ...
    private synchronized void a(int var1, int var2, int var3, int var4) {
        ...
        if (this.y[0] > this.y.length) {
            this.y = new int[1 + this.y[0]];
            this.y[0] = this.y.length - 1;
        }

        J(var1, 0);
        System.arraycopy(Code, Code, this.y, 1, this.y[0]);
        var1 = var3;
        int[] var16 = this.y;
        Code var17 = this;
        int[] var5;
            ...
            if (var17.w != null) {
                for(var1 = 1; var1 < var16[0]; var1 += 4) {
                    ...
                    if ((var8 = var17.J(var5, var6, var2, var7)) >= var2) {
                        ...
                        var16[var1 + 1] = var7 + var17.w[var8 * 5] - (var5[var6 + var8] & 16777215);
                        boolean var18 = true;
                        var10 = (var5[var6 + var8] & 16777215) + var17.w[var8 * 5 + 1];
                        ...
                        while(true) {
                            ...
                            if ((var5[var6 + var8] & -2147483648) == 0) {
                                ...
                                if (!var18) {
                                    var16[var1 + 1] = var17.w[var8 * 5];
                                    var18 = true;
                                }

                                var10 += var17.w[var8 * 5 + 1];
                            }
                        }
                    }
                }
    ...
    private synchronized boolean Code(Code var1, int var2, int var3, int var4, int var5) {
        ...
        label285: {
            ...
            if (this.w == null || this.f == null || var5 == 0) {
                this.cn = var4;
                if (this.cv != 0) {
                    M.ao();
    ...
    private void Code(Code var1, char[] var2, int var3, int var4, int var5, int var6, boolean var7) {
        int var8 = 1;
        int var9 = Math.max(var6 / a(var5), 1);

        int var10;
        for(var10 = 0; var10 < var3 && var8 <= var9; ++var10) {
            var8 += (var2[var10] - 10 | -(var2[var10] - 10)) >>> 31 ^ 1;
        }

        for(var3 = var8; var10 > 0; --var10) {
            int var10000 = this.cy;
            int var10002;
            if (var7) {
                var10002 = a(var5);
                --var3;
                ...
                --var3;
                var10002 = var6 * var3 / var8;
            }

            var9 = var10000 + this.O(var10002);
            int var11 = 0;
            if (var3 == 0) {
                var11 = var10;
                var10 = 0;
            ...
            if (var11 > 0 && var2[var10 + var11 - 1] == '\r') {
                --var11;
            }
            ...
            var9 = this.cv;
            var11 = this.cn;
            boolean var12 = this.aL;
            int var13 = var10005;
            int var14 = this.cx;
            int var15 = var10003;
            if (var12) {
                Code(var1, var5, var2, var10, var15, var14, var13, var4);
            } else {
                int var21 = var13;
                var13 = var14;
                var14 = var15;
                ...
                int var18;
                int var19;
                if ((var18 = J(var5) << 6) != bO || var4 != bN) {
                    for(var19 = 0; var19 < n.length; ++var19) {
                        n[var19] = var18 + l[var19] << 24 | var4 & 16777215;
                    }
                ...
                var9 = ((Code(var5, var2, var10, var14) + 1) * var11 - 1) / var9;
                if ((var9 = Math.min((m.length >> 1) - 1, var9)) > 0 && var21 >= 0) {
                    var11 = Math.max(var9 / var14, 1);
                    if (!T && V && !as) {
                        var18 = (var10 << 1 | var14 << 2 ^ var9) % (m.length / 2 - var9) & -2;

                        for(var19 = 0; var19 < var9; ++var19) {
                            m[var19] = n[var18 + var19];
                            m[var9 + var19] = n[(n.length >> 1) + var18 + var19];
                        }

                        for(var18 = var10; var18 < var15 + var14; ++var18) {
                            if (var16[var18] == ' ') {
                                var19 = (var18 - var15) * var11;
                                int var20 = Math.min(var11, (m.length >> 1) - var19);
                                Z(m, var19, var20);
                                Z(m, var19 + var9, var20);
                            }
                        }

                        var11 = Math.max(0, -var13);
                        if (var9 > var11) {
                            var1.Code((int[])m, var11, var9 - var11, var13 + var11, var21, var9 - var11, 2);
                        }
                    } else {
                        var1.Z(var13, var21, var13 + var9, var21, var4);
                    }
                }
            }
        }
    ...
    private void Code(Code var1, int var2, int var3, int var4, int var5, int[] var6, int var7) {
        if (var5 >= 0) {
            ...
            var1.B(var2, var3, this.cn, this.O(this.w[var5 * 5] + this.w[var5 * 5 + 1]));
            var3 -= this.O(this.w[var4 * 5]);
            int var10 = 0;
            int var11 = 0;
            this.cD = 0;
            ...
            while(true) {
                ...
                for(var13 = var4; var13 <= var5; ++var13) {
                    for(var14 = this.w[var13 * 5 + 3]; this.w[var14] != 0; var14 += 4) {
                        this.w[var13 * 5 + 3] = var14;
                        if (this.w[var14 + 1] > this.cD) {
                            var12 = C(var12, this.cD, this.w[var14]);
                            if (this.w[var14] == var12) {
                                var10 = this.w[var14 + 2];
                                var11 = this.w[var14 + 3];
                            }
                            break;
                        }
                    }
                ...
                do {
                    for(var15 = var4; var15 <= var5; ++var15) {
                        for(int var16 = this.w[var15 * 5 + 3]; this.w[var16] != 0 && this.w[var16] <= var13 + this.az; var16 += 4) {
                            this.w[var15 * 5 + 3] = var16;
                            var13 = Math.max(var13, this.w[var16 + 1]);
                        }
                    }
                } while(var13 != var13);
                ...
                while(true) {
                    ...
                    do {
                                                ...
                                                switch(var18) {
                                                    ...
                                                    case 73:
                                                        ...
                                                        if (var17.cz > 0 && var17.cA > 0) {
                                                            ...
                                                            if (var18 != -1 && var15 != -1) {
                                                                if (var17.aL) {
                                                                    var53 = var17.Code(var21, var17.bk + var20, var13, var12, var23, var59, 256, var18, var15);
                                                                } else {
                                                                    var53 = var17.Code(var21, var17.bk + var20, var13, var12, var23, var59, var17.H(), var18, var15);
                                                                }
                                                            } else if (var17.aL) {
                                                                var53 = var17.Code(var21, var17.bk + var20, var13, var12, var23, var59, 256, -1, -1);
                                                            } else {
                                                                var53 = var17.Code(var21, var17.bk + var20, var13, var12, var23, var59, var17.H(), var23, var59);
                                                            }
                                                    ...
                                                    case 84:
                                                        ...
                                                        if (var17.aL) {
                                                            ...
                                                            if (var17.K.n.aE) {
                                                                ...
                                                                if (!var10000.Code() && !var67.Code()) {
                                                                    ...
                                                                    if (var30.Code.cp <= var15 && var67.Code.cp >= var15 && !var17.d(var15)) {
                                                                        ...
                                                                        Code var36 = var54;
                                                                        Code var37 = var78;
                                                                        if (var78.aE && !var37.B.Code() && !var37.a.Code()) {
                                                                            int var38 = a(var18);
                                                                            ...
                                                                            for(var41 = 0; var41 < var39; ++var41) {
                                                                                ...
                                                                                int var75 = var47.Code.cp == var70 ? var47.Code : 0;
                                                                                int var74 = var45.Code.cp == var70 ? var45.Code : var72;
                                                                                if (var75 <= var72 && var74 >= var71) {
                                                                                    var72 = var34 + var37.C.O(var62 * var41 / var39);
                                                                                    var44 = (var45 = B.Code(var37.B, var37.a)).Code.cp != var70 ? 0 : Math.max(0, var45.Code - var71);
                                                                                    var74 = Code(var64, var69, var71, var44);
                                                                                    var10002 = var71 + var44;
                                                                                    B var81 = var37.B;
                                                                                    B var48 = var37.a;
                                                                                    B var49 = var81;
                                                                                    var44 = Code(var64, var69, var10002, ((var48 = B.Code(var81, var48) == var49 ? var48 : var49).Code.cp != var70 ? var42 : Math.min(var48.Code - var71, var42)) - var44);
                                                                                    ...
                                                                                    if (var41 + 1 == var39) {
                                                                                        ...
                                                                                        if (!var10000.Code() && !var46.Code()) {
                                                                                            ...
                                                                                            if (var70 < var46.Code.cp) {
                                                                                                Code var76 = var37.C.I(var70, var32, var31);
                                                                                                if (Code(var31 + var62 * var41 / var39, a(var64), var76.cs, var76.G())) {
                                                            ...
                                                            Code var65;
                                                            if (!(var24 = var17.K.m.B).Code() && var24.Code.cp == var15 && !var17.d(var15) && (var65 = var17.K.m).b) {
                                                                var28 = var65.B.Z();
                                                                var29 = var65.B.J();
                                                                var70 = var65.B.B();
                                                        ...
                                                        var17.Code(var54, var22, (int)var24, var21, var18, var20, false);
                                                        continue label315;
                                                }
                                            } else {
                                                var17.T(var18);
                        ...
                        var56 = var54;
                        var58 = var17;
                    } while((var57 = (Vector)var17.O.J.get(new Integer(var59))) == null);

                    for(var59 = 0; var59 < var57.size(); ++var59) {
                        int[] var61;
                        int var79 = (var61 = (int[])var57.elementAt(var59))[9] - var58.K.az;
    ...
    private int T(int var1) {
        this.cD = var1 + 1 + 1 + 10 * this.f[var1 + 1];
        this.cD += 2;
    ...
    private synchronized int j(int var1, int var2) {
        if (this.t == null) {
            ...
            int var3;
            var1 = (var3 = this.t[var1 * 5 + 1]) + this.t[var1 * 5 + 2];
            int var4;
            int var5 = var4 = this.g(var3, this.br);

            while(true) {
                int var6;
                int var7 = (var6 = this.w[var5 * 5]) + this.w[var5 * 5 + 1];
                ...
                while(true) {
                    while(this.cD <= this.a) {
                        ...
                        for(int var5 = this.O(); var5 > 0; --var5) {
                            this.ay();
                            int var6 = this.g(this.cy, this.br);
    ...
    private synchronized int Code(int var1, char var2, int var3) {
        ...
        if (var2 == 0) {
            ...
            for(var5 = this.f[var1 - 1]; var5 > 0; --var5) {
                if (this.F(var1++) == var2) {
                    var6 = this.E(var1);
                    var1 += 2;
                    var4 = var6 + var1;
    ...
    private synchronized int Code(int var1, int var2, int var3, int var4) {
        ...
        e(Code(String.valueOf(var1)));
        if (this.F(var4) == 83) {
            this.cD = var4 + 2 + 10 * this.f[var4 + 1];
            e(Code(e(this.j())));
            var1 = ad;
    ...
    private int R() {
        int var1 = 0;
        if (Q && this.f != null) {
            var1 = 0 + this.f.length;
            if (this.w != null) {
                var1 += this.w.length << 2;
            }
        }
    ...
    private int U(int var1) {
        int var2 = 0;
        if (Q && var1 > 0 && this.f != null) {
            var2 = 0 + this.f.length;
            if (this.w != null) {
                var2 += this.w.length << 2;
            }
    ...
    private synchronized int Code(String var1, int[] var2, int var3) {
        ...
        if (var1.equals(this.K.b) && this.O != null) {
            if (!this.O.q()) {
                return 0;
            } else {
            ...
            int[] var38 = new int[]{var8.bo, var8.a, 0, 0};

            int var10;
            for(var8.bl = var8.C.I(var3, var38); var8.bl != -1; var8.bl = var8.C.I(var10 + 2 + var8.C.E(var10), var38)) {
                var8.bo = var38[0];
                var8.a = var38[1];
                boolean var34 = false;
                var10 = var8.bl + 17;
                ...
                for(var8.br = 0; !var34 && var8.br < var40.length(); ++var8.br) {
                    int var10002 = var8.bl;
                    int var10003 = var8.br;
                    int var10005 = var8.bo;
                    int var10006 = var8.a;
                    ...
                    while(true) {
                        ...
                        if (var22.length() <= var19.length() - var20) {
                            ...
                            int var10001 = var23.bl;
                            var10002 = var23.br;
                            var10003 = var23.bo;
                            int var10004 = var23.a;
            ...
            while(var35.hasMoreElements()) {
                ...
                while(var37 < var36.length) {
                    ...
                    if (var33.J.containsKey(var39)) {
                        ((Vector)var33.J.get(var39)).addElement(var38);
                        ++var37;
                    } else {
                        Vector var41;
                        (var41 = new Vector()).addElement(var38);
                        var33.J.put(var39, var41);
                        ++var37;
                    }
                }
            }
    ...
    private synchronized int S() {
        if (this.t == null) {
            ...
            int var10000 = this.t.length;
            Z(var10000, var10000);
            System.arraycopy(this.t, 0, Code, Code, this.t.length);
            return m();
        }
    }

    private synchronized int T() {
        int var10000 = this.br * 5;
        Z(var10000, var10000);
        System.arraycopy(this.w, 0, Code, Code, this.br * 5);
        return m();
    }
    ...
    private void B(byte[] var1, int var2) {
        ...
        System.arraycopy(var1, 0, this.g, 0, Math.min(64, var2));
