...
public final class C0009j {
    ...
    private int m37a() {
        ...
        while (true) {
            ...
            if (this.f135t == 0) {
                m41a();
                this.f136u++;
                if ((this.f130o <= 1 || this.f136u < this.f129n / (this.f125k * 8)) && (this.f130o != 1 || this.f136u < (((((this.f114e[i] * this.height) + this.f125k) - 1) / this.f125k) + 7) / 8)) {
                    m46b();
                }
            }
            this.f132q++;
    ...
    private void m41a() {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            if (i2 + i3 < this.height && this.f123j == 3) {
                ...
                if (this.f116f[0] == 2 && this.f116f[1] == 1 && this.f116f[2] == 1) {
                    ...
                    for (int i9 = 0; i9 < i8; i9++) {
                        ...
                        int i14 = i4 + 1;
                        this.rgb[i4] = f93a[i10 + s2 + 256] | (f93a[(i10 + s) + 256] << 16) | (f93a[(i10 - i13) + 256] << 8);
                        int i15 = this.f101a[0][(i9 << 1) + i5 + 1] & 255;
                        short s3 = f93a[i15 + s + 256];
                        short s4 = f93a[(i15 - i13) + 256];
                        short s5 = f93a[i15 + s2 + 256];
                        i4 = i14 + 1;
                        this.rgb[i14] = (s3 << 16) | (s4 << 8) | s5;
                    }
                    if ((this.width & 1) != 0) {
                        int i16 = this.f101a[0][(this.width + i5) - 1] & 255;
                        int i17 = this.f101a[1][((this.width - 1) >> 1) + i6] & 255;
                        short s6 = f93a[f97c[i17] + i16 + 256];
                        int i18 = (this.f101a[2][((this.width - 1) >> 1) + i7] & 255) - 128;
                        this.rgb[i4] = (f93a[(i16 + f95b[i18 + 128]) + 256] << 16) | (f93a[(i16 - ((((i17 - 128) * 705) + (i18 * 1463)) >> 11)) + 256] << 8) | s6;
                    }
                    ...
                    while (i19 < this.width) {
                        ...
                        this.rgb[i4] = (f93a[(i20 - ((((i21 - 128) * 705) + (i22 * 1463)) >> 11)) + 256] << 8) | (f93a[(i20 + f95b[i22 + 128]) + 256] << 16) | s7;
                        i19++;
                        i4++;
                    }
                } else {
                    ...
                    while (i23 < this.width) {
                        ...
                        int i24 = b3 - 128;
                        this.rgb[i4] = (f93a[(b - ((((b2 - 128) * 705) + (i24 * 1463)) >> 11)) + 256] << 8) | (f93a[(b + f95b[i24 + 128]) + 256] << 16) | f93a[f97c[b2] + b + 256];
                        i23++;
                        i4++;
                    }
                }
    ...
    private void m46b() {
        if (this.f130o == 1) {
            this.f135t = (((((this.f116f[this.f120h[this.f131p]] * this.width) + this.f127l) - 1) / this.f127l) + 7) / 8;
