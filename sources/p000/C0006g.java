...
public final class C0006g extends List {
    ...
    /* renamed from: a */
    public FormField f86a;

    public C0006g(String str, int i, FormField oVar) {
        super(str, i);
        this.f86a = oVar;
    }
    ...
    public final void mo25a() {
        if (!(this.f86a == null || this.f86a.f268a == null)) {
            ...
            if (!this.f86a.f272b && this.f86a.f270b > 50) {
                append(new StringBuffer().append(DrawingUtils.get_string_resource(104)).append("...").toString(), (Image) null);
            }
        }
    }
}
