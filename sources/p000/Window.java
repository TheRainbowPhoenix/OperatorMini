...
public final class Window {
    ...
    public Window(BrowserCanvas sVar, int i, int i2, int i3, int i4, int i5, int i6) {
        this.f304a = sVar;
        this.width = i;
        m174a(i2);
        this.x = i3;
    ...
    private int mo39a(int i) {
        if (i < 0 || i >= this.pageImageData.imageData.length) {
            return -1;
        }
        if (this.pageImageData.imageData[i] == 76 || this.pageImageData.imageData[i] == 87 || this.pageImageData.imageData[i] == 109) {
    ...
    private void m151a(Graphics graphics, int i, int i2, int i3, boolean z, boolean z2) {
        PageFont cVar;
        if (this.pageImageData != null && this.pageImageData.imageData != null && this.pageImageData.f454a != null) {
            PageFont cVar2 = null;
            ...
            int i6 = i4;
            while (true) {
                char c = (char) this.pageImageData.imageData[i6];
                int i7 = i6 + 1;
                m164d(i7);
                switch (c) {
                    case 'B':
                    ...
                    case 'D':
                        if (!z && !this.pageImageData.f465b) {
                            m149a(PageDataRunnable.m247a(DrawingUtils.m74a(this.pageImageData.imageData, i7)), graphics, this.x, i3, i);
                        }
                        i6 = i7 + 2;
                        cVar = cVar2;
                        break;
                    case 'E':
                        ...
                        break;
                    case 'F':
                        i6 = DrawingUtils.m74a(this.pageImageData.imageData, i7) + 2 + 1 + i7;
                        cVar = cVar2;
                        break;
                    case 'I':
                    case 'K':
                        int i8 = i7 + 2 + 2;
                        short a = DrawingUtils.m74a(this.pageImageData.imageData, i8);
                        int i9 = i8 + 2;
                        byte b = this.pageImageData.imageData[i9];
                        i6 = i9 + 1;
                        if (c == 'I') {
                            int a2 = i6 + 2 + DrawingUtils.m74a(this.pageImageData.imageData, i6);
                            i6 = a2 + 2 + DrawingUtils.m74a(this.pageImageData.imageData, a2);
                        }
                        ...
                        if (a3 != null) {
                            ...
                            if (this.form_field != null) {
                                this.f319e = false;
                                m148a(width2, height2, this.form_field.mo32a(false), this.form_field.m135a(), this.pageImageData.f472c[this.form_field.f281f]);
                    ...
                    case 'J':
                        short a4 = DrawingUtils.m74a(this.pageImageData.imageData, i7);
                        int i10 = i7 + 2;
                        short a5 = DrawingUtils.m74a(this.pageImageData.imageData, i10);
                        i6 = i10 + 2;
                        ...
                        if (this.form_field != null) {
                            this.f319e = false;
                            m148a(i11, i3, this.form_field.mo32a(false), this.form_field.m135a(), this.pageImageData.f472c[this.form_field.f281f]);
                            this.form_field = null;
                        } else if (!this.pageImageData.f465b) {
                    ...
                    case 'm':
                        ...
                        i6 = DrawingUtils.m74a(this.pageImageData.imageData, i7) + 2 + i7;
                        cVar = cVar2;
                        break;
                    case 'O':
                        i6 = i7 + 2;
                    ...
                    case 'R':
                        i6 = i7 + 2;
                        graphics.setColor(PageDataRunnable.m247a(DrawingUtils.m74a(this.pageImageData.imageData, i7)));
                        graphics.drawLine(i5, i3 + 1, (this.isVisible ? (this.width - 6) - 2 : this.width - 2) + DrawingUtils.f185g, i3 + 1);
                        cVar = cVar2;
                        break;
                    case 'T':
                        int i14 = this.pageImageData.imageData[i7] & 255;
                        int i15 = i7 + 1;
                        short a6 = DrawingUtils.m74a(this.pageImageData.imageData, i15);
                        int i16 = i15 + 2;
                        int a7 = DrawingUtils.m58a(this.pageImageData.imageData, i16, a6, f286a, 0);
                        i6 = i16 + a6;
                        if (!(cVar2 == null || cVar2.lcd_font == null)) {
                            ...
                            if ((z == this.f319e && !z2) || this.pageImageData.f465b) {
                                ...
                                if (!DrawingUtils.use_bitmap_font || this.pageImageData.f492g) {
                        ...
                        break;
                    case 'Y':
                        cVar = this.pageImageData.page_fonts[this.pageImageData.imageData[i7] & 255];
                        i6 = i7 + 1;
                        break;
                    case 'c':
                    case 'i':
                    ...
                    case 'x':
                        i6 = i7 + 2;
                        FormField oVar = this.pageImageData.page_forms[DrawingUtils.m74a(this.pageImageData.imageData, i7)];
                        oVar.f279d = this.f319e;
                        if (!z) {
                            oVar.paint_at(graphics, i5, i3);
                            if (c != 'i') {
                    ...
                    case 'h':
                        ...
                        break;
                    case 'y':
                        cVar = this.pageImageData.page_fonts[DrawingUtils.m74a(this.pageImageData.imageData, i7)];
                        i6 = i7 + 2;
                        break;
                    case 'z':
                        i5 += DrawingUtils.m74a(this.pageImageData.imageData, i7);
                        i6 = i7 + 2;
                        cVar = cVar2;
                        break;
                }
    ...
    private boolean m153a(int i) {
        if (this.pageImageData == null || this.pageImageData.imageData == null || this.pageImageData.f460a == null || this.pageImageData.f466b == null || this.pageImageData.f454a == null || i < 0 || i > this.pageImageData.imageData.length) {
            return false;
        }
        int f = this.pageImageData.m359f(i);
        if (this.pageImageData.imageData[i] == 76 || this.pageImageData.imageData[i] == 87 || this.pageImageData.imageData[i] == 80 || this.pageImageData.imageData[i] == 109) {
            int a = DrawingUtils.m74a(this.pageImageData.imageData, i + 1) + i + 2;
    ...
    private void m163c(Graphics graphics) {
        if (!(this.pageImageData == null || this.pageImageData.imageData == null || this.pageImageData.f460a == null || this.pageImageData.f466b == null || graphics == null || this.pageImageData.f451a <= 0 || this.f317d)) {
            int clipX = graphics.getClipX();
            int clipY = graphics.getClipY();
    ...
    /* renamed from: a */
    public final FormField m172a(int i) {
        return this.pageImageData.page_forms[DrawingUtils.m74a(this.pageImageData.imageData, i + 1)];
    }
    ...
    public final void m174a(int i) {
        if (i != this.height) {
            ...
            this.f339y = (this.height - DrawingUtils.m73a(BrowserCanvas.f345a, false)) - 4;
        }
    }
    ...
    public final void m175a(int i, int i2) {
        ...
        try {
            ...
            if (this.f304a.f428i || (DrawingUtils.f137A && (i == 49 || i == 51 || i == 55 || i == 57 || i == 48 || i == 35))) {
                ...
                switch (i) {
                    ...
                    case 56:
                        ...
                        break;
                    case 57:
                        this.f304a.search_field = new FormField('x', "q", "", "search:///", (String) null, 0, 0);
                        z4 = true;
                        z = false;
                        break;
                }
            ...
            switch (i4) {
                ...
                case 2:
                    if (z2 || !DrawingUtils.use_smooth_scroll) {
                    ...
                    if (this.pageImageData != null) {
                        ...
                        if (z4 || this.f300a >= 0) {
                            ...
                            if (e == 0) {
                                ...
                                if (a2 != null) {
                                    String a3 = DrawingUtils.m104b(a2).startsWith("javascript:") ? PageDataRunnable.m251a(this.pageImageData.page_forms, (FormField) null) : null;
                                    if (this.f304a != null) {
                                ...
                                this.f304a.mo68b(DrawingUtils.get_string_resource(73));
                                return;
                            } else if (e == 7) {
                                ...
                                this.f304a.mo68b(DrawingUtils.get_string_resource(105));
                                return;
                            } else if (e == 1) {
                                FormField a7 = m172a(this.f300a);
                                String str = null;
                                if (a7 != null) {
                                    str = a7.f278d;
                                }
                                String a8 = PageDataRunnable.m251a(this.pageImageData.page_forms, a7);
                                if (str == null) {
                                ...
                                FormField a9 = z4 ? this.f304a.search_field : m172a(this.f300a);
                                ...
                                String a11 = DrawingUtils.get_string_resource((a9.f278d == null || !a9.f278d.equals("search:///")) ? 48 : 55);
                                try {
                                    iVar = new C0008i(a11, str3, i5, i6, a9);
                                } catch (IllegalArgumentException e2) {
                                    iVar = new C0008i(a11, "", i5, i6, a9);
                                }
                                iVar.addCommand(BrowserCanvas.f366m);
                                iVar.addCommand(BrowserCanvas.f352d);
                                BrowserCanvas.m204a((Screen) iVar);
                                this.f304a.f423g = DrawingUtils.f200o && i4 == 8;
                                iVar.setCommandListener(this.f304a);
                                this.f304a.display.setCurrent(iVar);
                                return;
                            } else if (e == 3) {
                                FormField a12 = m172a(this.f300a);
                                if (this.pageImageData != null) {
                                    this.pageImageData.m348b(a12.f274c * 6);
                                }
                                a12.callback(this.f304a, i4);
                                return;
                            } else if (this.pageImageData.imageData != null) {
                                if ((this.pageImageData.imageData[this.f300a] == 114 || this.pageImageData.imageData[this.f300a] == 99) && (a = m172a(this.f300a)) != null) {
                                    if (a.input_charcode == 'c') {
                                        a.checked = !a.checked;
                                        this.f317d = false;
                                        this.f304a.mo70c();
                                    } else if (a.input_charcode == 'r' && !a.checked) {
                                        a.checked = true;
                                        if (!(this.pageImageData == null || this.pageImageData.page_forms == null)) {
                                            int length = this.pageImageData.page_forms.length;
                                            for (int i7 = 0; i7 < length; i7++) {
                                                FormField oVar = this.pageImageData.page_forms[i7];
                                                if ((oVar instanceof FormField) && oVar != a) {
                                                    FormField oVar2 = oVar;
                                                    if (oVar2.input_charcode == 'r' && oVar2.f265a.equals(a.f265a)) {
                                                        oVar2.checked = false;
                                                    }
                                                }
                                            }
            ...
            if (!(th instanceof OutOfMemoryError)) {
                this.f304a.mo68b(DrawingUtils.get_string_resource(72));
                this.f304a.mo76h();
    ...
    public final void paint(Graphics graphics) {
        ...
        try {
            ...
            if (max < min && max2 < min2) {
                ...
                drawBG(graphics);
                if (this.f315c && this.f324h > 1 && this.pageImageData != null && this.pageImageData.width > this.height && ((this.f326i == f289k && DrawingUtils.contentmagic) || this.f326i == f290l)) {
    ...
    /* renamed from: a */
    public final void mo44a(FormField oVar) {
        String a;
        if (oVar != null) {
            ...
            if (oVar.f276c) {
                this.f304a.mo65a(this.pageImageData.f443a, this.pageImageData.f443a, PageDataRunnable.m251a(this.pageImageData.page_forms, oVar));
            }
        }
    }
    ...
    public final synchronized void mo45a(PageDataRunnable uVar) {
        if (uVar != null) {
            switch (uVar.f494h) {
                ...
                case 9:
                    if (this.f304a != null) {
                        this.f304a.mo68b(DrawingUtils.get_string_resource(69));
                        break;
                    }
                    break;
                case 10:
    ...
    /* renamed from: b */
    public final boolean can_browse_forward() {
    ...
    public final void mo53e() {
        if (can_browse_forward() && this.f310b != null) {
            this.f316d = this.f313c;
            this.f316d++;
            this.f315c = true;
            this.f326i = f291m;
